 ...
 * Product card: Image-dominant (70/30), warm shadows, spring animations
 * White card on cream bg, badges with distinct colors
 */
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-cream-dark">
        ...
        <div className="absolute inset-0 bg-walnut/0 group-hover:bg-walnut/20 transition-colors duration-300 flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100">
          <button
            onClick={(e) => {
              e.stopPropagation();
              onViewDetails(product);
            }}
            className="p-3 bg-white/95 rounded-xl shadow-lg hover:bg-white transition-colors"
            title="View details"
          >
          ...
          <button
            ...
            className="p-3 bg-teal/95 rounded-xl shadow-lg hover:bg-teal transition-colors"
